...
2. Описана архитектура приложений (сколько потоков за что отвечают, придумать протокол обмена сообщениями между приложениями);
3. Создан репозиторий проекта на github;
4. Написан сервер;
5. Написан клиент;
6. Протестирован сервер при подключении нескольких клиентов;
7. Написать README.md к проекту;
8. Отправлен на проверку.
