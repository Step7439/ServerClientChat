...
Шаги реализации:
Нарисованы схемы приложений;
Описана архитектура приложений (сколько потоков за что отвечают, придумать протокол обмена сообщениями между приложениями);
Создан репозиторий проекта на github;
Написан сервер;
Написан клиент;
Протестирован сервер при подключении нескольких клиентов;
